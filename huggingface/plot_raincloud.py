'''
VMP 2023-09-11:
Generates the raincloud plot for the cosine distance
between responses generated for the 'could' and 'should'
conditions, which is used in the manuscript.
'''
...
# here including across conditions 
