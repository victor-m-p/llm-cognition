'''
VMP 2023-09-11:
1. Compute distance between options generated for 
different generation numbers. 
2. Distance against first generation (not used in manuscript)
3. heatmat of similarity within generations between num (not used in manuscript)
'''
...
### 1. similarity across generation numbers ###
...
### 2. distance to the first generation ###
